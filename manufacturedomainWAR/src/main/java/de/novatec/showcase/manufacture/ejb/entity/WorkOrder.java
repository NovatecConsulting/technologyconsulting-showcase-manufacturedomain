...
public class WorkOrder implements Serializable {
	...
	@Column(name = "WO_LOCATION", nullable = false)
	...
	@Column(name = "WO_ASSEMBLY_ID", length = 20)
	 ...
	 * @param assemblyId
	 */
	public WorkOrder(int location, int salesId, int orderLineId, WorkOrderStatus status, int originalQuantity, int completedQuantity,
			Calendar dueDate, Calendar startDate, String assemblyId) {
		super();
		this.location = location;
		this.salesId = salesId;
		this.orderLineId = orderLineId;
